...
- `t-layout-print-stack` (responsive stacking is default)
...
**Features:** `t-layout-grow`, `t-layout-shrink-0`, `t-layout-wrap`, `t-layout-justify-between`; daisyUI theme (`data-theme="cupcake"`), navbar area, menu, stats, cards, buttons. Responsive stacking is default.
